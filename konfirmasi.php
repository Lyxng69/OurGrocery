...
<head>
	<title>RIZQI JAYA - Konfirmasi Pembayaran</title>
	<!-- for-mobile-apps -->
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<meta name="keywords" content="Our Grocery, RIZQI JAYA" />
		...
		<div class="container">
			<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					<li><i class="fa fa-phone" aria-hidden="true"></i>Hubungi Kami : (+6285) 156 796 373</li>
				</ul>
			</div>
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php">Our Grocery</a></h1>
			</div>
			...
			<div class="login-form-grids">
				...
				<form method="post">
					...
					<div class="form-group">
						<h6>Upload Bukti Pembayaran : <a href="https://docs.google.com/forms/d/1R9v1hxIQQTypwJYBwzxnA-7xGTdddwnoc_A2LK7hWv4">Link</a></h6>
		...
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Rizqi Jaya, Kudus, Jawa Tengah.</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a>Rizqijaya@gmail.com</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>+62 85156 7963 73</li>
					</ul>
				</div>
